...
func (c *Client) ListScans(ctx context.Context, args ListScansArgs) (*ListScansResponse, error) {
	...
	if args.IncludePublic != nil {
		query.Set("include_public", strconvFormatBool(*args.IncludePublic))
	}
	if args.IncludeNotificationStatus != nil {
		query.Set("include_notification_status", strconvFormatBool(*args.IncludeNotificationStatus))
	}
...
func (c *Client) ListAlertEvents(ctx context.Context, args ListAlertEventsArgs) (*ListAlertEventsResponse, error) {
	...
	if args.Limit != nil {
		query.Set("limit", strconvFormatInt(*args.Limit))
	}
	if args.Cursor != nil {
...
func strconvFormatInt(v int) string {
